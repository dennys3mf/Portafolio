import { y as ROUTE_TYPE_HEADER, z as REROUTE_DIRECTIVE_HEADER, D as DEFAULT_404_COMPONENT, A as AstroError, B as ActionNotFoundError, C as clientAddressSymbol, G as LocalsNotAnObject, H as FailedToFindPageMapSSR, J as REROUTABLE_STATUS_CODES, K as responseSentSymbol, O as nodeRequestAbortControllerCleanupSymbol } from './astro/server_CH_ZUc5U.mjs';
import colors from 'piccolore';
import 'clsx';
import { D as DEFAULT_404_ROUTE, d as default404Instance, e as ensure404Route } from './astro-designed-error-pages_4P3auflu.mjs';
...
import { N as NOOP_MIDDLEWARE_FN } from './noop-middleware_D6bGcqsg.mjs';
